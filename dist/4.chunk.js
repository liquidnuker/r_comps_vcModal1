...
exports.default = {
  ...
  mounted: function mounted() {
    console.log("vcModal1.vue mounted");
  },
  methods: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4c39b8fa", module.exports)
  }
}
...
Component.options.__file = "vue-components\\vcModal1.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vcModal1.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4c39b8fa", Component.options)
  } else {
    hotAPI.reload("data-v-4c39b8fa", Component.options)
  }
